...
const faqs = [
  ...
  },
  {
    ...
    answer: 'В Филиале РГУ нефти и газа (НИУ) имени И.М. Губкина в городе Ташкенте доступны следующие формы обучения: очная (дневная) форма обучения - длительностью 4 года для программ бакалавриата, 2 года для программ магистратуры.',
    category: 'study',
    hasLists: false
  },
  {
    ...
    answerIntro: 'Да, Филиал предоставляет общежитие иногородним студентам. Для заселения в общежитие необходимы следующие документы:',
    answerList: [
  ...
  {
    id: 6,
    question: 'Какие студенческие организации действуют в Филиале?',
    answerIntro: 'В Филиале действуют различные студенческие организации:',
    answerList: [
      'Студенческий совет',
  ...
  },
  {
    ...
    answerIntro: 'При поступлении в Филиал РГУ нефти и газа (НИУ) имени И.М. Губкина в городе Ташкенте могут предоставляться следующие льготы:',
    answerList: [

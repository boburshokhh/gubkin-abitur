    ...
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        ...
        <h2 class="text-3xl font-bold text-gray-900 mb-4">
          Прием на 2026 год закрыт
        </h2>
        
        <!-- Описание -->
        <p class="text-lg text-gray-600 mb-6">
          Подача новых заявлений на приемную кампанию 2026 года временно недоступна.
          Если вы уже отправили документы, статус заявления можно проверить в личном кабинете.
        </p>
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-left">
              ...
              <ul class="mt-2 text-sm text-blue-700 space-y-1">
                <li>• Просмотреть статус уже поданных заявлений</li>
                <li>• Следить за результатами и уведомлениями</li>
                <li>• Получить справочную информацию</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
          <p class="text-sm text-gray-500">
            По вопросам приемной кампании обращайтесь:
          </p>
          <p class="text-sm text-gray-700 mt-1">
            <a href="mailto:admission@gubkin.uz" class="text-primary-600 hover:text-primary-500">
              admission@gubkin.uz
            </a>
          </p>
        </div>

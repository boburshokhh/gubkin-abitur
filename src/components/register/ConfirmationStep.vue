    ...
    <div class="flex items-start mt-4">
      ...
      <div class="ml-3 text-sm">
        ...
        <p class="text-xs text-gray-500 mt-1">
          Диплом победителя Республиканской олимпиады по математике или диплом победителя, призёра либо участника I Губкинской предметной олимпиады 2025 года
        </p>
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3">
            ...
            <div class="mt-2 text-sm text-yellow-700">
              <p>Загрузите цветную копию диплома победителя, призёра или участника I Губкинской предметной олимпиады 2025 года или диплома победителя Республиканской олимпиады по математике. Файл должен быть в формате PDF.</p>
            </div>            
          </div>
        </div>
      </div>
